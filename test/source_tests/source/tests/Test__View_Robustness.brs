Function TestSuite__ViewRobustness() as Object
  ...
  this.addTest("ViewRobustness [2] Internally Started", TestCase__MuxAnalytics_ViewRobustness_internal_start_2)
  this.addTest("ViewRobustness [3] Internally Started", TestCase__MuxAnalytics_ViewRobustness_internal_start_3)
  this.addTest("ViewRobustness [4] Internally Started", TestCase__MuxAnalytics_ViewRobustness_internal_start_4)
  this.addTest("ViewRobustness [5] Internally Started", TestCase__MuxAnalytics_ViewRobustness_internal_start_5)
  this.addTest("ViewRobustness [6] Internally Started", TestCase__MuxAnalytics_ViewRobustness_internal_start_6)
  this.addTest("ViewRobustness [7] Internally Started", TestCase__MuxAnalytics_ViewRobustness_internal_start_7)
  this.addTest("ViewRobustness [8] Internally Started", TestCase__MuxAnalytics_ViewRobustness_internal_start_8)
  this.addTest("ViewRobustness [9] Internally Started", TestCase__MuxAnalytics_ViewRobustness_internal_start_9)
  this.addTest("ViewRobustness [10] Internally Started", TestCase__MuxAnalytics_ViewRobustness_internal_start_10)
...
Function TestCase__MuxAnalytics_ViewRobustness_internal_start_1() as String
  ...
  m.SUT.init(m.fakeConnection, m.fakePort, m.fakeAppInfo, m.fakeConfig, {}, m.fakeTimer, m.fakeTimer)
  ' WHEN
  m.fakeSGNodeEvent._dataToReturn = "run"
